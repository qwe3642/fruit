...
public class Producter extends Thread {
    ...
    public Producter(String topic) {
        Properties properties = new Properties();
        properties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.0.128:9092,192.168.0.157:9092");
    ...
    public static void main(String[] args) {
        new Producter("test_partition").start();
    }
}
